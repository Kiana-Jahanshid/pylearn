...
class Game(arcade.Window) :
    def __init__(self):
        ...
        self.background = arcade.load_texture("Assignment_14/space.jpg" )
        self.Bullet_sound = arcade.load_sound("Assignment_14/q.wav")
        self.explosion_sound = arcade.load_sound("Assignment_14/ex.wav")
    ...
    def on_draw(self):
        ...
        for heart in self.hearts :          
            ...
            if self.game_over == True :
                self.clear()
                self.background = arcade.load_texture("Assignment_14/game-over (2).png")
                arcade.draw_lrwh_rectangle_textured(0 , 0 , self.width  , self.height  , self.background)


        arcade.draw_text(f"Score : {self.score}", 500, 20, arcade.color.WHITE, 17 ,font_name= 'arial', bold=True)
...
class GameOverView(arcade.View): 
    def __init__(self):
        super().__init__()
        self.texture = arcade.load_texture("Assignment_14/game-over (2).png")
